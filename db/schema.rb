...
ActiveRecord::Schema[8.0].define(version: 2026_06_30_120000) do
  ...
  create_table "hike_routes", force: :cascade do |t|
    ...
    t.index ["tags"], name: "index_hike_routes_on_tags", using: :gin
  ...
  create_table "route_bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hike_route_id"], name: "index_route_bookmarks_on_hike_route_id"
    t.index ["user_id", "hike_route_id"], name: "index_route_bookmarks_on_user_id_and_hike_route_id", unique: true
    t.index ["user_id"], name: "index_route_bookmarks_on_user_id"
  end
