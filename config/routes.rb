Rails.application.routes.draw do
  ...
  get    "/routes/:id/waypoints", to: "hike_routes#waypoints"
  post   "/routes/:id/waypoints", to: "hike_routes#create_waypoint"
  delete "/routes/:id/waypoints/:waypoint_id", to: "hike_routes#destroy_waypoint"
